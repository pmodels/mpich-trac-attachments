...
#define HAVE_MAX_INTEGER_ALIGNMENT 4
...
/* Controls byte alignment of structures (for aligning allocated structures)
   */
#define HAVE_MAX_STRUCT_ALIGNMENT 4
...
#define PACKAGE_STRING "MPICH2 1.5b1"
